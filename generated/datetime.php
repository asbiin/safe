 ...
 * 
 */
function date_sunrise(int $timestamp, int $returnFormat = SUNFUNCS_RET_STRING, float $latitude = null, float $longitude = null, float $zenith = null,  $utcOffset = 0)
{
    error_clear_last();
 ...
 * 
 */
function date_sunset(int $timestamp, int $returnFormat = SUNFUNCS_RET_STRING, float $latitude = null, float $longitude = null, float $zenith = null,  $utcOffset = 0)
{
    error_clear_last();
 ...
 * 
 */
function gmmktime(int $hour,  $minute = null,  $second = null,  $month = null, int $day = null, int $year = null): int
{
    error_clear_last();
 ...
 * 
 */
function mktime(int $hour,  $minute = null,  $second = null,  $month = null, int $day = null, int $year = null): int
{
    error_clear_last();
